...
class TestProductModel(unittest.TestCase):
    ...
    def test_deserialize_missing_attribute(self):
        ...
        data = {
            ...
            "price": "10.99",
            "available": True,  # Should be boolean, but passed as string
    ...
    def test_deserialize_type_attribute(self):
        ...
        data = {
            ...
            "description": "Test description",
            "price": "10.99",
            "available": 12,  # Should be boolean, but passed as string
            "category": "ELECTRONICS"
        }
    ...
    def test_deserialize_empty(self):
        ...
        data = {
            "name": "Test Product",
            "description": "Test description",
            "price": "10.99",  # Incorrect type (string instead of numeric)
            "available": True,
            "category": "ELECTRONICS"
        }
    ...
    def test_find_by_name(self):
        ...
        logging.debug("Find product by name...")
    ...
    def test_find_by_availability(self):
        ...
        logging.debug("Find product by availability...")
        for product in products:
            product.create()
    ...
    def test_find_by_category(self):
        ...
        products = ProductFactory.create_batch(10)
        logging.debug("Find product by category...")
        for product in products:
            product.create()
